---
title: "Prediction the manner of people doing the excercise."
...
As a result varImp output, we can see that variables roll_belt, pitch_forearm and yaw_belt have the highest importance. Let's plot 
```{r data_plot_1}
